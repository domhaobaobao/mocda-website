...
$address = 'info@mocda.org';

// Set the e-mail subject prefix.
$subject = 'Mocda - message from contact module';
...
if (!$error) {
  ...
  $subject = _contact_clean_str($subject, ENT_NOQUOTES, true, true);
  $type = _contact_clean_str($_POST['type'], ENT_QUOTES, true, true);
  ...
  $success = @mail($to, $subject, $email_message, $mail_headers, '-f' . $sender);
}
